# Run the server
    ...
    uvicorn main:app --reload --loop asyncio --env-file .env --host 0.0.0.0 --ssl-keyfile /etc/letsencrypt/live/bittensorapi.com/privkey.pem --ssl-certfile /etc/letsencrypt/live/bittensorapi.com/fullchain.pem
    celery -A main.celery worker --loglevel=info -Q wikitensor --concurrency=3  
    celery --broker amqp://validator-api:vyz4uYxo@159.203.136.167:5672/wt2-bt flower
